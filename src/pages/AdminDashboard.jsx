...
const AdminDashboard = () => {
  ...
  const handleStatusUpdate = async (reservationId, newStatus) => {
    if (newStatus === "confirmed") {
      setEmailStatus("Envoi de l'email de confirmation...");
    }
    ...
    if (result.success) {
      if (newStatus === "confirmed") {
        setEmailStatus("✅ Email de confirmation envoyé au client !");
            ...
            {filteredReservations.length === 0 ? (
              ...
              >
                ...
                <p>
                  Aucune réservation{" "}
                  {activeTab !== "all"
                    ? `${getStatusText(activeTab).toLowerCase()}`
                    : ""}
                </p>
              </div>
            ) : (
                    ...
                    >
                      <div>
                        ...
                        >
                          <div>
                            <h3
                              style={{ margin: "0 0 5px 0", color: "#262526" }}
                            >
        ...
        >
          ...
          >
            ...
            <div style={{ display: "grid", gap: "15px" }}>
              ...
              <div>
                <strong>Nom:</strong> {selectedReservation.customer_name}
              </div>
              <div>
              ...
              <div>
                ...
                {selectedReservation.customer_phone || "Non renseigné"}
              </div>
              <div>
                <strong>Date:</strong> {formatDate(selectedReservation.date)}
              </div>
              <div>
                <strong>Heure:</strong> {selectedReservation.time}
              </div>
              <div>
              ...
              {selectedReservation.dishes &&
                selectedReservation.dishes.length > 0 && (
                  <div>
                    <strong>Plats commandés:</strong>
