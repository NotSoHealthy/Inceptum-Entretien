    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ color: '#c59d5f', fontSize: '3em', marginBottom: '20px' }}>✓</div>
          <h3 style={{ color: '#262526', marginBottom: '15px' }}>Réservation Confirmée!</h3>
          <p style={{ color: '#666' }}>
            Votre réservation a été envoyée avec succès. Nous vous contacterons bientôt pour la confirmer.
          </p>
        </div>
      </div>
    );
      ...
      <div style={{
        ...
        {selectedDishes.length > 0 && (
          <div style={{ marginBottom: '30px', padding: '20px', background: '#f9f9f9', borderRadius: '8px' }}>
            <h4 style={{ color: '#c59d5f', marginBottom: '15px' }}>Plats Sélectionnés</h4>
            {selectedDishes.map((dish, index) => (
              <div key={index} style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
                <span>{dish.name}</span>
                <span style={{ color: '#c59d5f', fontWeight: '600' }}>{dish.price} €</span>
              </div>
            ))}
